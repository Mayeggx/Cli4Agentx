...
CREATE INDEX IF NOT EXISTS idx_session_nodes_topic_created ON session_nodes(topic_id, created_at);
CREATE UNIQUE INDEX IF NOT EXISTS idx_session_nodes_run ON session_nodes(run_id);
